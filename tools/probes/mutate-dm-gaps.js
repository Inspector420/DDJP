...
const ROWS = [
  ...
  { id: "M1", file: "ch", part: "A",
    ...
    find: "    try { MatrixAccount.setDMScope(ids); } catch (e) {}",
    repl: "    try { MatrixAccount.setDMScope(ids.concat((MatrixAccount.dmInviteRoomIds()||[]).map(function(i){return i.roomId;}))); } catch (e) {}   /*DMM1*/",
  ...
  { id: "M4", file: "ch", part: "A",
    ...
    find: "    try { return MatrixAccount.dmInviteRoomIds() || []; } catch (e) { return []; }",
    repl: "    return MatrixAccount.dmInviteRoomIds() || [];   /*DMM4*/",

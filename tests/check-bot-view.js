...
// SUBJECT: features/botruntime.js, core/chatprefs.js, ui/player.js, features/playback.js
...
{
  // The media load site moved to ui/player.js with the PLAYER cluster (roles.md §5). PART C
  // already asserted APPLIED on locating it, so the move turned this red rather than quiet —
  // which is why this re-point is a correction and not a rescue.
  const ui = require("fs").readFileSync(path.join(__dirname, "..", "ui", "player.js"), "utf8");

...
const KNOWN_GLOBALS = [
  "Logger", "StorageIO", "IDB", "Store", "EventCache", "StateDeriver", "PlaylistDoc",
  "StreamManager", "BlockManager", "MatrixBridge", "Playlists",
  "RoomUpgrade", "Queue", "UserQueue", "Skip", "Reactions", "Playback", "Room", "Media", "WindowedList", "Chat", "ChatBuffer", "ChatPrefs", "MetadataService",
];

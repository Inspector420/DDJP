...
// SUBJECT: backends/backend1/matrixbridge.js, backends/backend1/streammanager.js, backends/backend1/eventcache.js
...
const noop = () => {};
const MB = loadInContext(["backends/backend1/ranks.js", "backends/backend1/matrixbridge.js"], { Logger: { info: noop, warn: noop, error: noop, debug: noop } }).MatrixBridge;
...
function smCtx() {
  ...
  return loadInContext(["core/logger.js", "core/idb.js", "backends/backend1/ranks.js", "backends/backend1/statederiver.js", "backends/backend1/eventcache.js", "backends/backend1/streammanager.js"], { localStorage });
}

...
// SUBJECT: features/mediablocked.js, ui/player.js
...
//
// ── DRIVEN, NOT MATCHED ──────────────────────────────────────────────────────────────────────
// `ui/player.js` is read as source text by several guards and executed by few — the weakness that
...
console.log(
  ...
  "handler set is DERIVED from ui/player.js and every member is accounted for, so a handler " +

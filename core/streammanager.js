...
const StreamManager = (() => {
  let eventLog = [];
  let derivedState = { nowPlaying: null, rotation: [], settings: { chat: "uncategorized", vis: "private", bg: null } };
  const subscribers = {};
  ...
  function reset() {
    eventLog = [];
    derivedState = { nowPlaying: null, rotation: [], settings: { chat: "uncategorized", vis: "private", bg: null } };
